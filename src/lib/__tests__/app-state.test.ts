...
// ═══════════════════════════════════════════════════════
// findStaleDownstreamRecords — REMOVED in v1.4.7
...
// processSale() honors Specific ID selections from the FULL lot pool — cross-wallet
// lots are used with walletMismatch tagging for warnings, never silently dropped.
// ═══════════════════════════════════════════════════════
